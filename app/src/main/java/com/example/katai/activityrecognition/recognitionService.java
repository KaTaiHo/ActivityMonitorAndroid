            ...
            switch (msg.what)
            {
                case MSG_RECOGNIZER_START_LISTENING:
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN)
                    {
                        ...
                        if (!mIsStreamSolo)
                        {
//                            mAudioManager.setStreamSolo(STREAM_VOICE_CALL, true);
                            mIsStreamSolo = true;
                        }
                    }
                ...
                case MSG_RECOGNIZER_CANCEL:
                    if (mIsStreamSolo)
                    {
//                        mAudioManager.setStreamSolo(STREAM_VOICE_CALL, false);
                        mIsStreamSolo = false;
                    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Message recordMessage = new android.os.Message();
        recordMessage.what = MSG_RECOGNIZER_START_LISTENING;
        IncomingHandler incomingHandler = new IncomingHandler(new recognitionService());
        incomingHandler.handleMessage(recordMessage);
